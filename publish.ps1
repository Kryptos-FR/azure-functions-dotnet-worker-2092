...
dotnet nuget push --source "C:\Projects\Packages" CustomBinding.GooglePubSub.Core\bin\Debug\CustomBinding.GooglePubSub.Core.1.2.3.4.nupkg
dotnet nuget push --source "C:\Projects\Packages" CustomBinding.GooglePubSub.Worker\bin\Debug\CustomBinding.GooglePubSub.Worker.1.2.3.4.nupkg
